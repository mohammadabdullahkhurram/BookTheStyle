{{-- Bluejaypro's live GHL booking calendar (CSP: app.marketing_embed_src). --}}
<div class="overflow-hidden rounded-[20px] border border-border bg-card p-2" style="box-shadow: 0 16px 48px rgba(28,27,26,.08);">
